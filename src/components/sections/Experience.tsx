...
export default function Experience() {
  return (
    <section
      id="experience"
      className="relative mx-auto flex min-h-[120vh] w-full max-w-4xl flex-col items-center justify-center px-4 py-24 md:px-8"
    >
      <motion.h2
      ...
      <p className="mt-3 text-center text-muted">My professional journey.</p>
      ...
      <div className="mt-14 w-full space-y-6">
        {experiences.map((job, index) => (
          <motion.article
            ...
            whileHover={{ y: -4 }}
            className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 shadow-card backdrop-blur-sm transition hover:border-accent/50 hover:shadow-glow md:p-8"
          >
